...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should accept valid addresses" do
    valid_addresses = %w[user@example.com USER@foo.com A-US-ER@foo.bar.org
                       first.last@food.jp alice+bob@baz.com]
  ...
  test "email validation should reject invalid addresses" do
    invalid_addresses = %w[user@example,com USER_at_foo..com A-US-ER@foo.bar.
                       first.last@food_baz.jp alice+bob@baz+bar.com]
  ...
  test "email address shold be saved as lower-case" do
